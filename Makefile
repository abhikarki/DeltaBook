...
MAIN_DEPS = main.cpp orderbook.hpp parsed_update.hpp spsc_queue.hpp telemetry.hpp
PY_DEPS = kalshi_orderbook.cpp orderbook.hpp parsed_update.hpp spsc_queue.hpp telemetry.hpp
